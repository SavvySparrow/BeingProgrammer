 ...
 */
public class QuizBeginner extends ActionBarActivity {
  Toolbar toolbar;
    ...
    setContentView(R.layout.quizmenu_list);
        ...
        setTitle("Quiz Test-Beginner");
        final String categories[] = {"Quiz Set 1", "Quiz Set 2", "Quiz Set 3", "Quiz Set 4", "Quiz Set 5"};
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    QuestionActivity.End = 59;
                QuestionActivity.max_timer=0;
                QuestionActivity.NegativeMarking=0;

                startActivity(new Intent(QuizBeginner.this, QuizFetchActivity.class));
            }
        });
    }
