 ...
 */
public class QuizIntermediate extends ActionBarActivity {
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Quiz Test-Intermediate");
        final String categories[] = {"Quiz Set 1", "Quiz Set 2", "Quiz Set 3", "Quiz Set 4"};
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                QuestionActivity.End = 69;
                QuestionActivity.NegativeMarking = 1;
                QuestionActivity.max_timer=15;
                startActivity(new Intent(QuizIntermediate.this, QuizFetchActivity.class));
            }
        });
    }
