 ...
 */
public class ThemePageFragment2 extends android.support.v4.app.Fragment implements View.OnClickListener {
    Context context;
    ImageView imageView;
    View rootView;
    @Override
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.theme_indego);
