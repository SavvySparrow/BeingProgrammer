 ...
 */
public class ThemePageFragment1 extends android.support.v4.app.Fragment implements View.OnClickListener {
...
ImageView imageView;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.theme_teal);
    ...
    public void onClick(View v) {
        ...
        MainActivity.Theme_id = 1;
        //NavUtils.shouldUpRecreateTask(getActivity(), myhome);
        Intent myhome = new Intent(getActivity(), MainActivity.class);
